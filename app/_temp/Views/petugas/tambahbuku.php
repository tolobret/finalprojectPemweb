      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="../petugas/saveBuku" method="POST" enctype="multipart/form-data">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="jml" name="jml" placeholder="Masukkan Jumlah">
                  </div>
                </div>
                <div class="row">
                  <div class="form-group col-md-6">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-6">
                    <label for="inputLampiran">Lampiran Buku</label>
                    <div class="input-group">
                      <div class="custom-file">
                ...
                <div class="row">
                  <div class="form-group col-md-6">
                    <label for="InputSummernote">Keterangan Lainnya</label>
