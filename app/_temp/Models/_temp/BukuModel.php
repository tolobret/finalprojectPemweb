...
class BukuModel extends Model
{
    ...
    protected $allowedFields = ['buku_id', 'id_kategori', 'jml', 'id_rak', 'isbn', 'lampiran', 'title', 'penerbit', 'pengarang', 'thn_buku', 'sampul'];
    ...
    public function buat_kode($kodeawal, $idkode, $orderby, $limit)
    {
        ...
        if ($count > 0) {
            ...
            $hasil = $kodeawal . ($count + 1);
        } else {
            $hasil = $kodeawal . $count;
        }
        return $hasil;
    }
}
