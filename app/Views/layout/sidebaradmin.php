        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
             ...
             with font-awesome or any other icon font library -->
                <li class="nav-item ">
                    <a href="<?= base_url('admin/'); ?>" class="nav-link <?= ($segment == 'admin' || $segment == 'tambahpetugas' || $segment == 'profilepetugas') ? 'active' : '' ?>">
                ...
                <li class="nav-item">
                    <a href="<?= base_url('admin/admindataanggota'); ?>" class="nav-link <?= ($segment == 'admindataanggota' || $segment == 'tambahuser' || $segment == 'profileanggota') ? 'active' : '' ?>">
