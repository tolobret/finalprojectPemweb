                        ...
                        <div class="col-sm-8">
                            <table class="table table-stripped">
                                <tr>
                                    <td>ID Anggota</td>
                                    <td>:</td>
                                    <td><?= $datauser['0']['anggota_id']; ?></td>
                                </tr>
                                <tr>
                                    <td>Nama</td>
                                    <td>:</td>
                                    <td><?= $datauser['0']['nama']; ?></td>
                                </tr>
                                <tr>
                                    <td>TTL</td>
                                    <td>:</td>
                                    <td><?= $datauser['0']['tempat_lahir']; ?>, <?= $datauser['0']['tgl_lahir']; ?></td>
                                </tr>
                                <tr>
                                    <td>Alamat</td>
                                    <td>:</td>
                                    <td><?= $datauser['0']['alamat']; ?></td>
                                </tr>
                                <tr>
                                    <td>Tgl Bergabung</td>
                                    <td>:</td>
                                    <td><?= $datauser['0']['tgl_bergabung']; ?></td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-sm-4 text-center">
                            <img src="<?= base_url(('img') . "/" . session()->get('foto')) ?>" class="img-responsive" alt="User Image" style="width:3cm;height:4cm;">
                        </div>
                    </div>
                </div>
            </div>
